...
<head>
    ...
    <title>Rejected Goods - Owner Dashboard</title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <div class="float-sm-right">
                                <a href="{{ route('owner.rejected-goods.create') }}" class="btn btn-primary btn-lg">
                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('owner.rejected-goods.show', $rejectedGood) }}" class="btn btn-info btn-sm">
                                                            <i class="fas fa-eye mr-1"></i>View
                                                        </a>
                                                        <form method="POST" action="{{ route('owner.rejected-goods.destroy', $rejectedGood) }}" style="display: inline;" onsubmit="return confirm('Are you sure?')">
                                                            @csrf
                                                            @method('DELETE')
                                                ...
                                                <tr>
                                                    <td colspan="8" class="text-center text-muted py-5">
                                                        <div class="empty-state">
                                                            ...
                                                            <a href="{{ route('owner.rejected-goods.create') }}" class="btn btn-primary mt-3">
